...
//            if not null must contain 'application'
//            (if it doesn't default application will be used)
//            can contain 'connectPolicy' if there is no
//            connectPolicy default SimpleConnectPolicy will be used
//            if it contains heartbeatInterval then heartbeat on JSTP
//            connection will be started with it
