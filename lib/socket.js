...
//
// see transportCommon.newCreateConnectionFn
//
const newCreateConnectionFn = connect =>
  transportCommon.newCreateConnectionFn(
    socketFactory(connect),
    Transport
  );

// Same as newCreateConnectionFn but will also perform inspect of specified
// interfaces.
//
// see transportCommon.newCreateConnectionAndInspectFn
//
const newCreateConnectionAndInspectFn = connect =>
  transportCommon.newCreateConnectionAndInspectFn(
    socketFactory(connect),
    Transport
  );
...
module.exports = {
  Transport,
  newCreateConnectionFn,
  newCreateConnectionAndInspectFn
};
